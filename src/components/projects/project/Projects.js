...
export const PROJECTS = [
  ...
  },
  {
    ...
    caption: 'Analyzing game state trees to decide the optimal next move in Tic Tac Toe',
    image: tic_tac_toe_ai,
    link: 'https://github.com/karthik-taranath/tic-tac-toe-ai',
  },
  {
    title: 'Dynamic Robot Block Stacker',
    caption: 'Programming a robot arm to identify blocks and precisely stack them',
